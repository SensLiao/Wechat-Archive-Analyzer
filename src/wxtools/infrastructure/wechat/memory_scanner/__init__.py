...
if TYPE_CHECKING:
    from wxtools.infrastructure.wechat.memory_scanner.base import MemoryScanner


def get_scanner() -> MemoryScanner:
    """Return a MemoryScanner for the current platform."""
    if sys.platform == "win32":
        from wxtools.infrastructure.wechat.memory_scanner.windows import WindowsMemoryScanner
        return WindowsMemoryScanner()
    elif sys.platform == "darwin":
        from wxtools.infrastructure.wechat.memory_scanner.macos import MacosMemoryScanner
