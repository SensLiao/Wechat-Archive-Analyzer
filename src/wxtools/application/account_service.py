...
def resolve_data_dir(cfg: Config) -> Path:
    ...
    """
    from wxtools.infrastructure.wechat.account_discovery import find_wechat_data_dir
...
def list_accounts(cfg: Config) -> list[dict]:
    ...
    """
    from wxtools.infrastructure.wechat.account_discovery import discover_accounts
